    ...
    try {
      ...
      final history = (historyResponse.data ?? const <dynamic>[]).map((item) {
        ...
        return DoseHistoryItem(
          ...
          time: map['scheduled_at']?.toString() ??
  ...
  Widget build(BuildContext context) {
    ...
    if (_error != null) {
      return ResponsiveCenter(
        child: StatusMessageCard(message: _error!, onRetry: _loadMetrics),
      );
    }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Adherencia últimos 30 días',
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final color = switch (status) {
                      'TAKEN' => AppTheme.success,
                      'SKIPPED' => AppTheme.danger,
